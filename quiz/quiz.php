        ...
        <?php
            ...
            echo '<div class="choix du niveau">
                ...
                if ($_SESSION[$progression] >= 40){
                    echo '<div><a class="button difficile" href="quiz.php?type='.$_GET["type"].'&niv=3">difficile</a></div>';
                }else{
                    
                    echo '<div><a class="button bloquer difficile" href="quiz.php?type='.$_GET["type"].'">difficile</a></div>';
                }
